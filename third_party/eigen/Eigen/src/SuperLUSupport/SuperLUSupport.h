...
#  define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE)                                                                    \
    ...
    extern void PREFIX##gssvx(superlu_options_t*, SuperMatrix*, int*, int*, int*, char*, FLOATTYPE*, FLOATTYPE*,    \
                              ...
                              FLOATTYPE*, FLOATTYPE*, FLOATTYPE*, GlobalLU_t*, mem_usage_t*, SuperLUStat_t*, int*); \
    }                                                                                                               \
    inline float SuperLU_gssvx(superlu_options_t* options, SuperMatrix* A, int* perm_c, int* perm_r, int* etree,    \
      ...
      GlobalLU_t gLU;                                                                                               \
      PREFIX##gssvx(options, A, perm_c, perm_r, etree, equed, R, C, L, U, work, lwork, B, X, recip_pivot_growth,    \
                    rcond, ferr, berr, &gLU, &mem_usage, stats, info);                                              \
...
#  define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE)                                                                    \
    ...
    inline float SuperLU_gssvx(superlu_options_t* options, SuperMatrix* A, int* perm_c, int* perm_r, int* etree,    \
      ...
      mem_usage_t mem_usage;                                                                                        \
      PREFIX##gssvx(options, A, perm_c, perm_r, etree, equed, R, C, L, U, work, lwork, B, X, recip_pivot_growth,    \
                    rcond, ferr, berr, &mem_usage, stats, info);                                                    \
      return mem_usage.for_lu; /* bytes used by the factor storage */                                               \
    }
#endif
...
#  define DECL_GSISX(PREFIX, FLOATTYPE, KEYTYPE)                                                                    \
    ...
    inline float SuperLU_gsisx(superlu_options_t* options, SuperMatrix* A, int* perm_c, int* perm_r, int* etree,    \
      ...
      mem_usage_t mem_usage;                                                                                        \
      PREFIX##gsisx(options, A, perm_c, perm_r, etree, equed, R, C, L, U, work, lwork, B, X, recip_pivot_growth,    \
                    rcond, &mem_usage, stats, info);                                                                \
      return mem_usage.for_lu; /* bytes used by the factor storage */                                               \
    }
...
MappedSparseMatrix<Scalar, Flags, Index> map_superlu(SluMatrix& sluMat) {
  ...
  return MappedSparseMatrix<Scalar, Flags, Index>(sluMat.nrow, sluMat.ncol, sluMat.storage.outerInd[outerSize],
