 ...
 */
template <typename Packet>
EIGEN_DEVICE_FUNC inline typename enable_if<unpacket_traits<Packet>::masked_load_available, Packet>::type ploadu(
 ...
 */
template <typename Scalar, typename Packet>
EIGEN_DEVICE_FUNC inline typename enable_if<unpacket_traits<Packet>::masked_store_available, void>::type pstoreu(
