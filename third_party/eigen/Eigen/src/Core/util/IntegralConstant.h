...
// The generic typename T is mandatory. Otherwise, a code like fix<N> could refer to either the function above or this
// next overload. This way a code like fix<N> can only refer to the previous function.
 ...
 *
 * If for some reason you want a true object in c++98 then you can write: \code fix<N>() \endcode which is also valid in
 * c++14.
 *
