...
/// mingw, etc.)
#if EIGEN_COMP_GNUC && !(EIGEN_COMP_CLANG || EIGEN_COMP_ICC || EIGEN_COMP_MINGW || EIGEN_COMP_PGI || EIGEN_COMP_IBM || \
                         EIGEN_COMP_ARM || EIGEN_COMP_EMSCRIPTEN)
...
#if !(EIGEN_COMP_CLANG &&                                                                                            \
          ((EIGEN_COMP_CLANG < 309) || (defined(__apple_build_version__) && (__apple_build_version__ < 9000000))) || \
...
#  if EIGEN_MAX_CPP_VER >= 11 && \
      (__has_feature(cxx_rvalue_references) || (EIGEN_COMP_CXXVER >= 11) || (EIGEN_COMP_MSVC >= 1600))
...
#  if EIGEN_MAX_CPP_VER >= 11 && EIGEN_HAS_CXX11 &&                                                                 \
      (__has_feature(cxx_alignas) || EIGEN_HAS_CXX14 || (EIGEN_COMP_MSVC >= 1800) || (EIGEN_GNUC_AT_LEAST(4, 8)) || \
       (EIGEN_COMP_CLANG >= 305) || (EIGEN_COMP_ICC >= 1500) || (EIGEN_COMP_PGI >= 1500) ||                         \
...
#  if EIGEN_MAX_CPP_VER >= 11 && (EIGEN_HAS_CXX11 || EIGEN_COMP_MSVC >= 1700) && \
      ((!EIGEN_COMP_GNUC_STRICT) || EIGEN_GNUC_AT_LEAST(5, 1)) && ((!defined(__GLIBCXX__)) || __GLIBCXX__ > 20150626)
...
#  if EIGEN_MAX_CPP_VER >= 11 &&                                                                \
      ((EIGEN_COMP_CXXVER > 11) ||                                                              \
       (EIGEN_COMP_CXXVER == 11) &&                                                             \
           (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || EIGEN_COMP_MSVC || EIGEN_COMP_ICC) && \
...
#  if EIGEN_MAX_CPP_VER >= 11 &&                                                                                \
      ((EIGEN_COMP_CXXVER > 11) || ((EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || \
                                                                  EIGEN_COMP_MSVC || EIGEN_COMP_ICC >= 1400)))
...
#  if EIGEN_MAX_CPP_VER >= 11 && (__has_feature(cxx_noexcept) || (EIGEN_COMP_CXXVER > 11) ||                   \
                                  ((EIGEN_COMP_CXXVER == 11) && (EIGEN_COMP_GNUC_STRICT || EIGEN_COMP_CLANG || \
                                                                 EIGEN_COMP_MSVC || EIGEN_COMP_ICC >= 1400)))
...
#  if EIGEN_MAX_CPP_VER >= 11 && (__has_feature(cxx_atomic) || (EIGEN_COMP_CXXVER > 11) || \
...
#  if EIGEN_MAX_CPP_VER >= 11 && (EIGEN_COMP_CXXVER >= 11 || EIGEN_COMP_MSVC >= 1700)
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHERIGHT(METHOD, OPNAME)                                                       \
  template <typename T>                                                                                              \
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE EIGEN_MSVC10_WORKAROUND_BINARYOP_RETURN_TYPE(                                \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHELEFT(METHOD, OPNAME)                                                        \
  template <typename T>                                                                                              \
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE friend EIGEN_MSVC10_WORKAROUND_BINARYOP_RETURN_TYPE(                         \
