 ...
 * aren't a multiple of the packet size. \tparam _MaxRows Maximum number of rows. Defaults to \a _Rows (\ref maxrows
 * "note"). \tparam _MaxCols Maximum number of columns. Defaults to \a _Cols (\ref maxrows "note").
 *
