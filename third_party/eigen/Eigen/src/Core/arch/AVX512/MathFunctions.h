...
#  define _EIGEN_DECLARE_CONST_Packet16bf(NAME, X) const Packet16bf p16bf_##NAME = pset1<Packet16bf>(X)
...
template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d plog<Packet8d>(const Packet8d& _x) {
...
template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f plog2<Packet16f>(const Packet16f& _x) {
  return plog2_float(_x);
}

template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d plog2<Packet8d>(const Packet8d& _x) {
...
template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d pexp<Packet8d>(const Packet8d& _x) {
...
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f psqrt<Packet16f>(const Packet16f& _x) {
  ...
  __mmask16 denormal_mask =
      _mm512_kand(_mm512_cmp_ps_mask(_x, pset1<Packet16f>((std::numeric_limits<float>::min)()), _CMP_LT_OQ),
...
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet8d psqrt<Packet8d>(const Packet8d& _x) {
  ...
  __mmask16 denormal_mask =
      _mm512_kand(_mm512_cmp_pd_mask(_x, pset1<Packet8d>((std::numeric_limits<double>::min)()), _CMP_LT_OQ),
...
template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f plog1p<Packet16f>(const Packet16f& _x) {
...
template <>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED Packet16f pexpm1<Packet16f>(const Packet16f& _x) {
