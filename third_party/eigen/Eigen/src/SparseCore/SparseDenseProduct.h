...
struct sparse_dense_outer_product_evaluator {
 protected:
  ...
  typedef typename conditional<is_same<typename internal::traits<Lhs1>::StorageKind, Sparse>::value, Lhs1,
                               SparseView<Lhs1> >::type ActualLhs;
  typedef typename conditional<is_same<typename internal::traits<Lhs1>::StorageKind, Sparse>::value, Lhs1 const&,
