...
struct traits<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType> > {
  ...
  static const int Layout = XprTraits::Layout;
  typedef
      typename TypeConversion<Scalar,
...
struct traits<TensorSelectOp<IfXprType, ThenXprType, ElseXprType> > : traits<ThenXprType> {
  ...
  static const int Layout = XprTraits::Layout;
  typedef
      typename conditional<Pointer_type_promotion<typename ThenXprType::Scalar, Scalar>::val,
                           typename traits<ThenXprType>::PointerType, typename traits<ElseXprType>::PointerType>::type
          PointerType;
};
