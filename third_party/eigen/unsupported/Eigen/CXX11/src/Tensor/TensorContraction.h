...
struct traits<TensorContractionOp<Dimensions, LhsXprType, RhsXprType, OutputKernelType> > {
  ...
  typedef typename conditional<Pointer_type_promotion<typename LhsXprType::Scalar, Scalar>::val,
                               typename traits<LhsXprType>::PointerType, typename traits<RhsXprType>::PointerType>::type
      PointerType;
...
struct TensorContractionKernel {
  ...
  EIGEN_DEVICE_FUNC
  TensorContractionKernel(StorageIndex m_, StorageIndex k_, StorageIndex n_, StorageIndex bm_, StorageIndex bk_,
                          StorageIndex bn_)
...
struct TensorContractionEvaluatorBase : internal::no_assignment_operator {
  ...
  typedef typename internal::conditional<static_cast<int>(Layout) == static_cast<int>(ColMajor), LeftArgType,
                                         RightArgType>::type EvalLeftArgType;
  typedef typename internal::conditional<static_cast<int>(Layout) == static_cast<int>(ColMajor), RightArgType,
