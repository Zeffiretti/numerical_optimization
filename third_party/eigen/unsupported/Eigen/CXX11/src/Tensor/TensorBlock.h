...
class TensorCwiseUnaryBlock {
 ...
 public:
  typedef typename conditional<NoArgBlockAccess, void,
 ...
 public:
  typedef typename conditional<NoArgBlockAccess, void,
                               TensorCwiseBinaryOp<BinaryOp, const typename LhsTensorBlock::XprType,
                                                   const typename RhsTensorBlock::XprType> >::type XprType;
...
class TensorUnaryExprBlock {
 ...
 public:
  typedef typename conditional<NoArgBlockAccess, void, typename BlockFactory::template XprType<ArgXprType>::type>::type
      XprType;
...
class TensorTernaryExprBlock {
  ...
  static const bool NoArgBlockAccess = internal::is_void<Arg1XprType>::value || internal::is_void<Arg2XprType>::value ||
                                       internal::is_void<Arg3XprType>::value;

 public:
  typedef
      typename conditional<NoArgBlockAccess, void,
