...
static void glad_gl_load_GL_VERSION_3_0(GLADuserptrloadfunc load, void* userptr) {
  ...
  glGetFramebufferAttachmentParameteriv =
      (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC)load("glGetFramebufferAttachmentParameteriv", userptr);
  ...
  glRenderbufferStorageMultisample =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC)load("glRenderbufferStorageMultisample", userptr);
...
static void glad_gl_load_GL_VERSION_3_2(GLADuserptrloadfunc load, void* userptr) {
  ...
  glDrawElementsInstancedBaseVertex =
      (PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC)load("glDrawElementsInstancedBaseVertex", userptr);
