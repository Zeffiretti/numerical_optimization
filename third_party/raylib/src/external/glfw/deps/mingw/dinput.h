...
DECLARE_INTERFACE_(IDirectInputDevice2A, IDirectInputDeviceA) {
  ...
  (THIS_ REFGUID rguid, LPCDIEFFECT lpeff, LPDIRECTINPUTEFFECT * ppdeff, LPUNKNOWN punkOuter) PURE;
  ...
  (THIS_ LPDIENUMCREATEDEFFECTOBJECTSCALLBACK lpCallback, LPVOID pvRef, DWORD fl) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A) {
  ...
  (THIS_ LPCSTR lpszFileName, LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef, DWORD dwFlags) PURE;
  STDMETHOD(WriteEffectToFile)
  (THIS_ LPCSTR lpszFileName, DWORD dwEntries, LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
  ...
  STDMETHOD(EnumEffectsInFile)
  (THIS_ LPCWSTR lpszFileName, LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef, DWORD dwFlags) PURE;
  STDMETHOD(WriteEffectToFile)
  (THIS_ LPCWSTR lpszFileName, DWORD dwEntries, LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
  ...
  STDMETHOD(FindDevice)(THIS_ REFGUID rguid, LPCWSTR pszName, LPGUID pguidInstance) PURE;
  STDMETHOD(EnumDevicesBySemantics)
  (THIS_ LPCWSTR ptszUserName, LPDIACTIONFORMATW lpdiActionFormat, LPDIENUMDEVICESBYSEMANTICSCBW lpCallback,
   LPVOID pvRef, DWORD dwFlags) PURE;
  STDMETHOD(ConfigureDevices)
  (THIS_ LPDICONFIGUREDEVICESCALLBACK lpdiCallback, LPDICONFIGUREDEVICESPARAMSW lpdiCDParams, DWORD dwFlags,
   LPVOID pvRefData) PURE;
};
#  undef INTERFACE
